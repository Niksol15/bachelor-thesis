...
- Інакше $lambda = (y_q - y_p) / (x_q - x_p)$
- $x = lambda ^ 2 - x_p - x_q; y = lambda(x_p - x) - y_p arrow.r P plus.circle Q = (x, y)$
\

$(E(FF_p), plus.circle)$ утворюють абелеву групу.
...
+ Імплементація додавання точок еліптичної кривої має працювати за константний час, інакше можлива атака що викриває приватний ключ.
+ В цьому алгоритмі не вказано   
=== Montgomery Curve
